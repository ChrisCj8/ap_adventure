...
function TOOL:LeftClick(tr)
    ...
    if name == "" then apAdventure.ToolWarn("noloc",self:GetOwner()) return end
    if tonumber(name) then apAdventure.ToolWarn("locnum",self:GetOwner()) return end
    if name[1] == " " then apAdventure.ToolWarn("loclead",self:GetOwner()) return end
    if name[#name] == " " then apAdventure.ToolWarn("loctrail",self:GetOwner()) return end
